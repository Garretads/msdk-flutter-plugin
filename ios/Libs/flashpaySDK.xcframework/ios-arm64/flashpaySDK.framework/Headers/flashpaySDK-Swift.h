...
/// \param url_api API url to send requests to
///
/// \param url_socket Socket url to listen for callbacks
///
- (nonnull instancetype)initWithApi:(NSString * _Nonnull)apiUrlString socket:(NSString * _Nonnull)socketUrlString OBJC_DESIGNATED_INITIALIZER;
...
/// \param paymentCurrency Payment currency in ISO 4217 alpha-3 format
///
- (nonnull instancetype)initWithProjectID:(int32_t)projectID paymentID:(NSString * _Nonnull)paymentID paymentAmount:(int64_t)paymentAmount paymentCurrency:(NSString * _Nonnull)paymentCurrency OBJC_DESIGNATED_INITIALIZER;
